...
-- joining both table
SELECT a.district,a.state,a.sex_ratio,b.population from dataset1 a inner join dataset2 b on a.district = b.district;
...
-- output districts from each state with highest literacy rate LIMIT 3
